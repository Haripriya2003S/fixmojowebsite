<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="bookingelec.aspx.cs" Inherits="fixmojowebsite.bookingelec" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="box">
      ...
      <center> <h1>Booking Details</h1></center>
         <% if (!string.IsNullOrEmpty(lblligin.Text)) { %>
         <asp:Label ID="lblliginname" runat="server" Text="ligin" ></asp:Label>&nbsp;&nbsp;<asp:Label ID="lblligin" runat="server" Text="painting"  ></asp:Label><br />   <% } %>
  
        <% if (!string.IsNullOrEmpty(lblligrep.Text)) { %>
        <asp:Label ID="lblligrepname" runat="server" Text="Water"  ></asp:Label>&nbsp;&nbsp;<asp:Label ID="lblligrep" runat="server" Text="water" ></asp:Label><br /> <% } %>
  
        <% if (!string.IsNullOrEmpty(lblfanin.Text)) { %>
        <asp:Label ID="lblfaninname" runat="server" Text="intpt"  ></asp:Label>&nbsp;&nbsp<asp:Label ID="lblfanin" runat="server" Text="intpt" ></asp:Label><br /> <% } %>
 
        <% if (!string.IsNullOrEmpty(lblfanrep.Text)) { %>
        <asp:Label ID="lblfanrepname" runat="server" Text="extpt" ></asp:Label>&nbsp;&nbsp<asp:Label ID="lblfanrep" runat="server" Text="extpt"  ></asp:Label><br /> <% } %>
