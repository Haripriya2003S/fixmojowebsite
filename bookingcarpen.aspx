<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="bookingcarpen.aspx.cs" Inherits="fixmojowebsite.bookingcarpen" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="box">
      ...
      <center> <h1>Booking Details</h1></center>
         <% if (!string.IsNullOrEmpty(lbldoorrep.Text)) { %>
         <asp:Label ID="lbldoorrepname" runat="server" Text="Door Repait" ></asp:Label>&nbsp;&nbsp;<asp:Label ID="lbldoorrep" runat="server" Text="repair"  ></asp:Label><br />   <% } %>
 
        <% if (!string.IsNullOrEmpty(lbldoorin.Text)) { %>
        <asp:Label ID="lbldoorinname" runat="server" Text="Water"  ></asp:Label>&nbsp;&nbsp;<asp:Label ID="lbldoorin" runat="server" Text="water" ></asp:Label><br /> <% } %>
 
        <% if (!string.IsNullOrEmpty(lblfur.Text)) { %>
        <asp:Label ID="lblfurname" runat="server" Text="Furnitture Repair"  ></asp:Label>&nbsp;&nbsp<asp:Label ID="lblfur" runat="server" Text="intpt" ></asp:Label><br /> <% } %>
 
        <% if (!string.IsNullOrEmpty(lblcup.Text)) { %>
        <asp:Label ID="lblcupname" runat="server" Text="CupBoard Installation and Repair" ></asp:Label>&nbsp;&nbsp<asp:Label ID="lblcup" runat="server" Text="extpt"  ></asp:Label><br /> <% } %>
